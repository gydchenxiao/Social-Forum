...
import io.college.modules.sys.dao.SysConfigDao;
import io.college.modules.sys.entity.SysConfigEntity;
import io.college.modules.sys.redis.SysConfigRedis;
...
public class SysConfigServiceImpl extends ServiceImpl<SysConfigDao, SysConfigEntity> implements SysConfigService {
	...
	public <T> T getConfigObject(String key, Class<T> clazz) {
		...
		try {
			...
			throw new collegeException("获取参数失败");
		}
	}
}
